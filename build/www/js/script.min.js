...
var _createClass = (function () {
        ...
        return (
            _createClass(a, [
                ...
                },
              {
                ...
                {
                    key: "talk",
                    value: function (a, b, c, url) {
                        var d = this;
                        
  url = "https://www.tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(b) + "&voice=" + encodeURIComponent("Adult Male #2, American English (TruVoice)") + "&pitch=140&speed=157";
  c = c || false;
  ...
  this.speakID = BonziHandler.speak(url, this.userPublic.speed, this.userPublic.pitch, function (a) {
    if (a) d.clearDialog();
  });
                  },
              },
