    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                (this.userPublic = c || { name: "BonziBUDDY", color: "purple", colorUrl: "", speed: 175, pitch: 50, voice: "en" }),
      ...
      console.log("User info window closed");
                ...
                },
                {
                    ...
                    value: function (force) {
                        if (this.color != this.userPublic.color || force) {
      this.color = this.userPublic.color;
      
      if (this.userPublic.colorUrl) {
        var img = new Image();
        img.onload = function() {
          var colorSprite = new createjs.Bitmap(img);
          this.sprite.removeAllChildren();
          this.sprite.addChild(colorSprite);
          this.sprite.gotoAndPlay("idle");
        }.bind(this);
        img.src = this.userPublic.colorUrl;
      } else {
        var spriteData = this.data.sprite,
          spriteSheet = new createjs.SpriteSheet({
            images: [this.data.sizes[this.size].image],
