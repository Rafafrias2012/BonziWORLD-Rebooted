                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").removeClass("bubble_autowidth").css("display", "block"),
                            this.stopSpeaking(),
                          var url = "https://www.tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(b) + "&voice=" + encodeURIComponent("Adult Male #2, American English (TruVoice)") + "&pitch=140&speed=157";

// Create an audio element and play the synthesized speech
var audio = new Audio(url);
audio.play();

// Clear the dialog when audio ends
